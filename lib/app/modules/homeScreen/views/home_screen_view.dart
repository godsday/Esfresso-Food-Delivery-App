...
class HomeScreenView extends GetView<HomeScreenController> {
  ...
  final homeCtrlr=Get.put( HomeScreenController());
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: CustomScrollView(
        slivers: <Widget>[
          SliverAppBar(leading: SizedBox(),
            pinned: false,backgroundColor: Colors.white,
            expandedHeight: 150,
            flexibleSpace: FlexibleSpaceBar(
              title: TextCustomStyle(textData: "What would you like \nto order", textSize: 20.0, textWeight: FontWeight.bold,textColor: Colors.black,)
            ),

          ),
     SliverFillRemaining(

      child:HomeBody(searchController: searchController, activeColor: activeColor, inActiveColor: inActiveColor)
     )
        ],
      ),
    );
        ...
        // body: HomeBody(searchController: searchController, activeColor: activeColor, inActiveColor: inActiveColor));
  }
}
